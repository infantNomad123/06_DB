...
SELECT * FROM DEPT_COPY2;
 ...
 -- D0 / NULL /L2	
 -->  NULL 은 DB 무결성을 약하게 만드는 원인
 ---> 가능하면 NULL이 생기지 않도록 하는 것이 좋다!!!!

--WITH READ ONLY 옵현을 추가해서 일기 전용으로 변경!
...
SELECT SEQ_TEST_NO.CURRVAL FROM DUAL; --100(오류X)
...
-- TB_TEST 테이블 INSERT 시 기퀀스 사용하기
INSERT INTO TB_TEST VALUES(SEQ_TEST_NO.NEXTVAL,  '홍길동'); -- 125
INSERT INTO TB_TEST VALUES(SEQ_TEST_NO.NEXTVAL,  '김영희'); -- 125
INSERT INTO TB_TEST VALUES(SEQ_TEST_NO.NEXTVAL,  '박철수'); -- 125
...
SELECT * FROM TB_TEST; -- 130 _> 145 으로 변경

--시퀀스 SEQ_TEST_NO.NEXTVAL exceeds MAXVALUE은 사례로 될 수 없습니다
--> 시퀀스는 MAXVALUE 값을 초괴해서 증가할 수 없다
...
-- 인덱스 사용 방법 ! -> WHERE 절에 INDEX 가 지정된 컬럼 언급 하기
...
WHERE TEST_ID = 'TEST500000'; -- 0.019
